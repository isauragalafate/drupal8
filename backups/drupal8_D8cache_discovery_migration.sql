...
--
-- Table structure for table `D8cache_discovery_migration`
--

DROP TABLE IF EXISTS `D8cache_discovery_migration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8cache_discovery_migration` (
...
--
-- Dumping data for table `D8cache_discovery_migration`
--

LOCK TABLES `D8cache_discovery_migration` WRITE;
/*!40000 ALTER TABLE `D8cache_discovery_migration` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8cache_discovery_migration` ENABLE KEYS */;
UNLOCK TABLES;
