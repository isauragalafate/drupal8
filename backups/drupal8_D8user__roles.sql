...
--
-- Table structure for table `D8user__roles`
--

DROP TABLE IF EXISTS `D8user__roles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8user__roles` (
...
--
-- Dumping data for table `D8user__roles`
--

LOCK TABLES `D8user__roles` WRITE;
/*!40000 ALTER TABLE `D8user__roles` DISABLE KEYS */;
INSERT INTO `D8user__roles` VALUES ('user',0,1,1,'en',0,'administrator');
/*!40000 ALTER TABLE `D8user__roles` ENABLE KEYS */;
UNLOCK TABLES;
