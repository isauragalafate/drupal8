...
--
-- Table structure for table `D8shortcut_field_data`
--

DROP TABLE IF EXISTS `D8shortcut_field_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8shortcut_field_data` (
...
--
-- Dumping data for table `D8shortcut_field_data`
--

LOCK TABLES `D8shortcut_field_data` WRITE;
/*!40000 ALTER TABLE `D8shortcut_field_data` DISABLE KEYS */;
INSERT INTO `D8shortcut_field_data` VALUES (1,'default','en','Add content',-20,'internal:/node/add',NULL,'a:0:{}',1),(2,'default','en','All content',-19,'internal:/admin/content',NULL,'a:0:{}',1);
/*!40000 ALTER TABLE `D8shortcut_field_data` ENABLE KEYS */;
UNLOCK TABLES;
