...
--
-- Table structure for table `D8cache_page`
--

DROP TABLE IF EXISTS `D8cache_page`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8cache_page` (
...
--
-- Dumping data for table `D8cache_page`
--

LOCK TABLES `D8cache_page` WRITE;
/*!40000 ALTER TABLE `D8cache_page` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8cache_page` ENABLE KEYS */;
UNLOCK TABLES;
