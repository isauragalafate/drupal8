...
--
-- Table structure for table `D8user__user_picture`
--

DROP TABLE IF EXISTS `D8user__user_picture`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8user__user_picture` (
...
--
-- Dumping data for table `D8user__user_picture`
--

LOCK TABLES `D8user__user_picture` WRITE;
/*!40000 ALTER TABLE `D8user__user_picture` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8user__user_picture` ENABLE KEYS */;
UNLOCK TABLES;
