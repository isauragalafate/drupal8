...
--
-- Table structure for table `D8node_access`
--

DROP TABLE IF EXISTS `D8node_access`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8node_access` (
  `nid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'The D8node.nid this record affects.',
  `langcode` varchar(12) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The D8language.langcode of this node.',
...
--
-- Dumping data for table `D8node_access`
--

LOCK TABLES `D8node_access` WRITE;
/*!40000 ALTER TABLE `D8node_access` DISABLE KEYS */;
INSERT INTO `D8node_access` VALUES (0,'',1,0,'all',1,0,0);
/*!40000 ALTER TABLE `D8node_access` ENABLE KEYS */;
UNLOCK TABLES;
