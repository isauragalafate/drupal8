...
--
-- Table structure for table `D8comment_field_data`
--

DROP TABLE IF EXISTS `D8comment_field_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8comment_field_data` (
...
--
-- Dumping data for table `D8comment_field_data`
--

LOCK TABLES `D8comment_field_data` WRITE;
/*!40000 ALTER TABLE `D8comment_field_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8comment_field_data` ENABLE KEYS */;
UNLOCK TABLES;
