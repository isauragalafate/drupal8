...
--
-- Table structure for table `D8node_revision__field_tags`
--

DROP TABLE IF EXISTS `D8node_revision__field_tags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8node_revision__field_tags` (
...
--
-- Dumping data for table `D8node_revision__field_tags`
--

LOCK TABLES `D8node_revision__field_tags` WRITE;
/*!40000 ALTER TABLE `D8node_revision__field_tags` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8node_revision__field_tags` ENABLE KEYS */;
UNLOCK TABLES;
