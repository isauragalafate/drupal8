...
--
-- Table structure for table `D8paragraph__field_view`
--

DROP TABLE IF EXISTS `D8paragraph__field_view`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8paragraph__field_view` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for paragraph field field_view.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `D8paragraph__field_view`
--

LOCK TABLES `D8paragraph__field_view` WRITE;
/*!40000 ALTER TABLE `D8paragraph__field_view` DISABLE KEYS */;
INSERT INTO `D8paragraph__field_view` VALUES ('embed_view',0,1,3,'en',0,'basic_page','block_1',NULL,0,NULL),('embed_view',0,2,10,'en',0,'basic_page','block_1',NULL,0,NULL),('embed_view',0,3,11,'en',0,'basic_page','block_2',NULL,1,NULL);
/*!40000 ALTER TABLE `D8paragraph__field_view` ENABLE KEYS */;
UNLOCK TABLES;
