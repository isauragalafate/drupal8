...
--
-- Table structure for table `D8file_usage`
--

DROP TABLE IF EXISTS `D8file_usage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8file_usage` (
...
--
-- Dumping data for table `D8file_usage`
--

LOCK TABLES `D8file_usage` WRITE;
/*!40000 ALTER TABLE `D8file_usage` DISABLE KEYS */;
INSERT INTO `D8file_usage` VALUES (1,'file','brick','2',1);
/*!40000 ALTER TABLE `D8file_usage` ENABLE KEYS */;
UNLOCK TABLES;
