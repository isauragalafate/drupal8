...
--
-- Table structure for table `D8node__comment`
--

DROP TABLE IF EXISTS `D8node__comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8node__comment` (
...
--
-- Dumping data for table `D8node__comment`
--

LOCK TABLES `D8node__comment` WRITE;
/*!40000 ALTER TABLE `D8node__comment` DISABLE KEYS */;
INSERT INTO `D8node__comment` VALUES ('article',0,4,6,'en',0,2),('article',0,5,11,'en',0,2);
/*!40000 ALTER TABLE `D8node__comment` ENABLE KEYS */;
UNLOCK TABLES;
