...
--
-- Table structure for table `D8menu_link_content_data`
--

DROP TABLE IF EXISTS `D8menu_link_content_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8menu_link_content_data` (
...
--
-- Dumping data for table `D8menu_link_content_data`
--

LOCK TABLES `D8menu_link_content_data` WRITE;
/*!40000 ALTER TABLE `D8menu_link_content_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8menu_link_content_data` ENABLE KEYS */;
UNLOCK TABLES;
