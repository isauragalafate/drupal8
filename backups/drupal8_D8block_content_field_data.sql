...
--
-- Table structure for table `D8block_content_field_data`
--

DROP TABLE IF EXISTS `D8block_content_field_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8block_content_field_data` (
...
--
-- Dumping data for table `D8block_content_field_data`
--

LOCK TABLES `D8block_content_field_data` WRITE;
/*!40000 ALTER TABLE `D8block_content_field_data` DISABLE KEYS */;
INSERT INTO `D8block_content_field_data` VALUES (1,1,'basic','en',1,'Testing',1531776508,1,1);
/*!40000 ALTER TABLE `D8block_content_field_data` ENABLE KEYS */;
UNLOCK TABLES;
