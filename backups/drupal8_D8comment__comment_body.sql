...
--
-- Table structure for table `D8comment__comment_body`
--

DROP TABLE IF EXISTS `D8comment__comment_body`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8comment__comment_body` (
...
--
-- Dumping data for table `D8comment__comment_body`
--

LOCK TABLES `D8comment__comment_body` WRITE;
/*!40000 ALTER TABLE `D8comment__comment_body` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8comment__comment_body` ENABLE KEYS */;
UNLOCK TABLES;
