...
--
-- Table structure for table `D8taxonomy_term_data`
--

DROP TABLE IF EXISTS `D8taxonomy_term_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8taxonomy_term_data` (
...
--
-- Dumping data for table `D8taxonomy_term_data`
--

LOCK TABLES `D8taxonomy_term_data` WRITE;
/*!40000 ALTER TABLE `D8taxonomy_term_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8taxonomy_term_data` ENABLE KEYS */;
UNLOCK TABLES;
