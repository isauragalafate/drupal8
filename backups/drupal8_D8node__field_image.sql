...
--
-- Table structure for table `D8node__field_image`
--

DROP TABLE IF EXISTS `D8node__field_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8node__field_image` (
...
--
-- Dumping data for table `D8node__field_image`
--

LOCK TABLES `D8node__field_image` WRITE;
/*!40000 ALTER TABLE `D8node__field_image` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8node__field_image` ENABLE KEYS */;
UNLOCK TABLES;
