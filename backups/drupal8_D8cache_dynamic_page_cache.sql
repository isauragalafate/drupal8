...
--
-- Table structure for table `D8cache_dynamic_page_cache`
--

DROP TABLE IF EXISTS `D8cache_dynamic_page_cache`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8cache_dynamic_page_cache` (
...
--
-- Dumping data for table `D8cache_dynamic_page_cache`
--

LOCK TABLES `D8cache_dynamic_page_cache` WRITE;
/*!40000 ALTER TABLE `D8cache_dynamic_page_cache` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8cache_dynamic_page_cache` ENABLE KEYS */;
UNLOCK TABLES;
