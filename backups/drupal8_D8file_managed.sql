...
--
-- Table structure for table `D8file_managed`
--

DROP TABLE IF EXISTS `D8file_managed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8file_managed` (
...
--
-- Dumping data for table `D8file_managed`
--

LOCK TABLES `D8file_managed` WRITE;
/*!40000 ALTER TABLE `D8file_managed` DISABLE KEYS */;
INSERT INTO `D8file_managed` VALUES (1,'59766b0a-6da1-4397-9460-3239ee1570ad','en',1,'druplicon.png','public://druplicon.png','image/png',40378,1,1531432729,1531432729);
/*!40000 ALTER TABLE `D8file_managed` ENABLE KEYS */;
UNLOCK TABLES;
