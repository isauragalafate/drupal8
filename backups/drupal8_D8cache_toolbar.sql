...
--
-- Table structure for table `D8cache_toolbar`
--

DROP TABLE IF EXISTS `D8cache_toolbar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8cache_toolbar` (
...
--
-- Dumping data for table `D8cache_toolbar`
--

LOCK TABLES `D8cache_toolbar` WRITE;
/*!40000 ALTER TABLE `D8cache_toolbar` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8cache_toolbar` ENABLE KEYS */;
UNLOCK TABLES;
