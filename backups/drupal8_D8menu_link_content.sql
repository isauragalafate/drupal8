...
--
-- Table structure for table `D8menu_link_content`
--

DROP TABLE IF EXISTS `D8menu_link_content`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8menu_link_content` (
...
--
-- Dumping data for table `D8menu_link_content`
--

LOCK TABLES `D8menu_link_content` WRITE;
/*!40000 ALTER TABLE `D8menu_link_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8menu_link_content` ENABLE KEYS */;
UNLOCK TABLES;
