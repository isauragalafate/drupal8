...
--
-- Table structure for table `D8brick__field_view`
--

DROP TABLE IF EXISTS `D8brick__field_view`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8brick__field_view` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for brick field field_view.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `D8brick__field_view`
--

LOCK TABLES `D8brick__field_view` WRITE;
/*!40000 ALTER TABLE `D8brick__field_view` DISABLE KEYS */;
INSERT INTO `D8brick__field_view` VALUES ('view',0,5,5,'en',0,'basic_page','block_1',NULL,0,NULL);
/*!40000 ALTER TABLE `D8brick__field_view` ENABLE KEYS */;
UNLOCK TABLES;
