...
--
-- Table structure for table `D8semaphore`
--

DROP TABLE IF EXISTS `D8semaphore`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `D8semaphore` (
...
--
-- Dumping data for table `D8semaphore`
--

LOCK TABLES `D8semaphore` WRITE;
/*!40000 ALTER TABLE `D8semaphore` DISABLE KEYS */;
/*!40000 ALTER TABLE `D8semaphore` ENABLE KEYS */;
UNLOCK TABLES;
